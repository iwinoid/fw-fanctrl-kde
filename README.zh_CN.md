...
1. 从 [Releases](https://github.com/iwinoid/fw-fanctrl-kde/releases) 页面下载 `com.github.iwinoid.fw-fanctrl-kde-1.3.tar.xz`。
...
- **1.3** ： 首个规范化版本：standard-readme 文档、QML 格式化与 lint 清零、单元测试、CI
