...
1. 从 [Releases](https://github.com/iwinoid/fw-fanctrl-kde/releases) 页面下载 `com.github.iwinoid.fw-fanctrl-kde-1.2.3.tar.xz`。
...
- **1.2.3** ： 格式化 QML 代码、清理 qmllint 警告、补充单元测试
